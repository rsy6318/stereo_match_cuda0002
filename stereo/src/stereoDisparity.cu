...
runTest(int argc, char **argv)
{
    ...
    unsigned int w, h;
    /*char *fname0 = sdkFindFilePath("im0.ppm", argv[0]);
    char *fname1 = sdkFindFilePath("im1.ppm", argv[0]);
    ...
    load_img("\/home\/rsy6318\/cuda-workspace\/stereo\/data\/im0.ppm",&h_img0,w,h);
    load_img("\/home\/rsy6318\/cuda-workspace\/stereo\/data\/im1.ppm",&h_img1,w,h);
